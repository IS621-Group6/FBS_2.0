...
export default function CalendarGrid({
  ...
  const selectedEndMin = selectedStartMin !== null ? selectedStartMin + selectedDuration : null
  ...
  return (
    <div className="stack" style={{ gap: 10 }}>
      ...
      <div className="calendarGrid" role="grid" aria-label="Time slots">
        {slots.map((slotMin) => {
          ...
          const isSelected =
            ...
            selectedEndMin !== null &&
            overlaps(slotMin, endMin, selectedStartMin, selectedEndMin)
